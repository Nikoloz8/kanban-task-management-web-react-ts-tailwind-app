...
export default function Header() {
    ...
    if (!ctx) return
    const { boards, setShowAddNewBoard, showAddNewBoard, setShowSidebar, showSidebar, showDotMenuHeader, setShowAddTask, showAddTask, setShowDotMenuHeader, setDeleteBoard, board, reset, toggle, setToggle } = ctx
        ...
        <header className={`w-[100%] flex relative bg-[#2B2C37] transition-all duration-1000 border-b-[1px] border-solid border-[#3E3F4E] ${toggle ? "bg-[#FFFFFF] border-[#E4EBFA]  " : ""}`}>
            <div className={`fixed z-20 ${showSidebar ? "left-0" : "left-[-310px]"} border-r-[1px] border-solid border-[#3E3F4E] overflow-y-auto custom-scroll transition-all duration-1000 top-0 h-[100%] flex flex-col justify-between bg-[#2B2C37] ${toggle ? "bg-[#FFFFFF] border-[#E4EBFA]" : ""}`}>
                ...
                <div className="flex flex-col gap-[22px] items-center">
                    ...
                    <div className="flex flex-col gap-[22px] w-[100%] pl-[24px] mb-[32px]">
            ...
            <div className="flex gap-[32px] w-[100%]">
                <div className={`p-[35px_32px_35px_24px] border-r-[1px] border-solid border-[#3E3F4E] ${toggle? "border-[#E4EBFA]" : ''}`}>
                ...
                <div className="p-[24px_32px] items-center w-[100%] flex justify-between">
                    <h1 className={`${H1} ${toggle ? "text-[#000112]!" : ""} text-[#FFFFFF] transition-all duration-1000 ${showSidebar && "ml-[77px]"}`}>{board}</h1>
