...
export default function Header() {
    ...
    if (!ctx) return
    const { boards, setShowAddNewBoard, showAddNewBoard, setShowSidebar, showSidebar, showDotMenuHeader, setShowAddTask, showAddTask, setShowDotMenuHeader, setDeleteBoard, board, reset, paramsBoard } = ctx
