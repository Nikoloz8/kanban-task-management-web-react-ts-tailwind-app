...
recharge the batteries a little." />
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="flex flex-col gap-[12px]">
              ...
              <button onClick={() => setSubtasks([...subtasks, subtasks[subtasks.length - 1] + 1])} className={`w-[100%] p-[8px] text-center rounded-[20px] bg-[#FFFFFF] ${P1} font-[700] text-[#635FC7] cursor-pointer`}>+ Add New Subtask</button>
            </div>
          </div>
        </form>
